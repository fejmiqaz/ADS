...
public class Main{
    ...
    private static int countDepth(BNode<Integer> node, int element){
      ...
      total += countDepth(node.left, element);
      total += countDepth(node.right, element);
    ...
    public static void main(String [] args){
        ...
        for(int i = 0; i < n + q; i++){
            ...
            if(instruction.equals("insert")){
                ...
                Integer el = sc.nextInt();
                Integer totalSmallerElements = countDepth(bst.getRoot(), el);
                System.out.println(totalSmallerElements);
            }
        }
    }
}
